...
class CloudBuildClient {
    ...
    constructor(opts) {
        ...
        this.pathTemplates = {
            buildTriggerPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/triggers/{trigger}'),
    ...
    initialize() {
        ...
        this.cloudBuildStub = this._gaxGrpc.createStub(this._opts.fallback
            ...
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.devtools.cloudbuild.v1.CloudBuild, this._opts);
     ...
     */
    buildTriggerPath(project, trigger) {
     ...
     */
    matchProjectFromBuildTriggerName(buildTriggerName) {
     ...
     */
    matchTriggerFromBuildTriggerName(buildTriggerName) {
        return this.pathTemplates.buildTriggerPathTemplate.match(buildTriggerName)
            .trigger;
    }
    /**
